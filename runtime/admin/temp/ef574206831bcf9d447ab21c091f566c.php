<?php /*a:4:{s:61:"D:\phpstudy_pro\WWW\xxp\app\admin\view\product\goods\add.html";i:1604630401;s:58:"D:\phpstudy_pro\WWW\xxp\app\admin\view\layout\default.html";i:1596373268;s:55:"D:\phpstudy_pro\WWW\xxp\app\admin\view\common\meta.html";i:1576229932;s:57:"D:\phpstudy_pro\WWW\xxp\app\admin\view\common\script.html";i:1576229932;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_select('row[category_id]', $category, null, ['class'=>'form-control', 'required'=>'', 'id'=>'cate']); ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" name="row[spec_name]" value="" placeholder="如：口味、重量等" data-rule="required"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" name="row[price]" value="" data-rule="required" />
        </div>
    </div>

    <div class="form-group">
        <label for="price" class="control-label col-xs-12 col-sm-2">销售价格:</label>
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" name="row[discount_price]" value=""  data-rule="required" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="number" class="form-control" name="row[inventory]" value="" />
        </div>
    </div>
    <div class="form-group">
        <label for="is_hot_sale" class="control-label col-xs-12 col-sm-2">是否热卖:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[is_hot_sale]', ['normal'=>'是', 'hidden'=>'不是']); ?>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-avatar" data-rule="" class="form-control" size="50" name="row[images]" type="text" value="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[is_recommend]', ['normal'=>'是', 'hidden'=>'不是']); ?>
        </div>
    </div>
    <div class="form-group">
        <label for="is_new" class="control-label col-xs-12 col-sm-2">新品:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[is_new]', ['normal'=>'是', 'hidden'=>'不是']); ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea name="row[introduce]" class="col-xs-12 col-sm-6" style="height: 200px"></textarea>
        </div>
    </div>
