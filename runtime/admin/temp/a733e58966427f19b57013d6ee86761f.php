<?php /*a:4:{s:62:"D:\phpstudy_pro\WWW\xxp\app\admin\view\product\goods\edit.html";i:1604644017;s:58:"D:\phpstudy_pro\WWW\xxp\app\admin\view\layout\default.html";i:1596373268;s:55:"D:\phpstudy_pro\WWW\xxp\app\admin\view\common\meta.html";i:1576229932;s:57:"D:\phpstudy_pro\WWW\xxp\app\admin\view\common\script.html";i:1576229932;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" name="row[spec_name]" value="<?php echo htmlentities($row['spec_name']); ?>" readonly placeholder="例：口味" data-rule="required"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" name="row[spec_value]" value="<?php echo htmlentities($row['spec_value']); ?>" readonly placeholder="属性多时，用 - 分割。例：麻辣-微辣-特辣" data-rule="required"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" name="row[discount_price]" value="<?php echo htmlentities(htmlentities($row['discount_price'])); ?>"  data-rule="required" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea name="row[introduce]" class="col-xs-12 col-sm-6" style="height: 200px"><?php echo htmlentities(htmlentities($row['introduce'])); ?></textarea>
        </div>
    </div>
